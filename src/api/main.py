"""Ticket Routing Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Intelligent ticket routing agent that classifies incoming IT tickets, assigns priority and category, routes to the appropriate support team, predicts resolution time, and balances workload across agents.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
